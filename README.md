...
This feature is disabled by default, it can be enabled by including the OverrideNewDelete module. One example of how to leverage this feature is the StrictMallocAllocator class in fprime-vorago